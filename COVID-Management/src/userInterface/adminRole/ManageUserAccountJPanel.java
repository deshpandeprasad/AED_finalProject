...
//this is the ManageUserAccountJPanel
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public ManageUserAccountJPanel(JPanel container, Enterprise enterprise, UserAccount userAccount) {
        ...
        userJTable.getTableHeader().setDefaultRenderer(new TableHeadColors());
   }
    ...
    public void popOrganizationComboBox() {
     ...
     public void populateOrganizationComboBox(){
        ...
        for(Organization organization :  enterprise.getOrganizationDirectory().getOrganizationList()){
            if(!(organization.getName().equals("Admin")) &&
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 107, 375, 179));

        jLabel8.setFont(new java.awt.Font("Malayalam MN", 3, 24)); // NOI18N
        jLabel8.setText("Manage Organization Admin");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(45, 44, 745, -1));
        ...
        add(jLayeredPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 310, -1, -1));
        ...
        add(backJButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 560, 108, -1));
